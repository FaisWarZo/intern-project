      ...
      <div className="container mx-auto mt-28 md:mt-32">
        ...
        <div className="grid grid-cols-1 gap-4 bg-gray-900 md:grid-cols-3">
          ...
          <div className="grid content-center">
            <div className="">
              ...
              <p className="text-center text-xl text-gray-200 ">Game_Filling</p>
            </div>
          </div>
        ...
        <div className="aboutcard overview mt-8 flex-row divide-y divide-solid divide-gray-500 p-7">
          ...
          <p className="py-7 text-base text-gray-500">
            Game_Filling is an open-world, action role-playing game that allows
            the player to control one of four interchangeable characters in a
            party.Switching between characters can be done quickly during
